...
CalendarPagesTabs(){
    ...
    VenueData vdata3 = new VenueData(imagelist3,'TL','003',DateTime.now(),DateTime.now(),'Chicago downtown', 'Chicago', 'City break', '\$\$', 'vibrant');
    ...
    VenueData vdata4 = new VenueData(imagelist4,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 2', 'Chicago', 'City break', '\$\$', 'vibrant');
    ...
    VenueData vdata5 = new VenueData(imagelist5,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 3', 'Chicago', 'City break', '\$\$', 'vibrant');
    ...
    imagelist3.add(image6);
    VenueData vdata6 = new VenueData(imagelist6,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 4', 'Chicago', 'City break', '\$\$', 'vibrant');
  ...
  // contruct vdata7
    ...
    imagelist3.add(image7);
    VenueData vdata7 = new VenueData(imagelist7,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 5', 'Chicago', 'City break', '\$\$', 'vibrant');
    ...
    imagelist3.add(image8);
    VenueData vdata8 = new VenueData(imagelist8,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 6', 'Chicago', 'City break', '\$\$', 'vibrant');
 ...
 // contruct vdata9
    ...
    imagelist3.add(image9);
    VenueData vdata9 = new VenueData(imagelist9,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 7', 'Chicago', 'City break', '\$\$', 'vibrant');
    ...
    imagelist3.add(image10);
    VenueData vdata10 = new VenueData(imagelist10,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 8', 'Chicago', 'City break', '\$\$', 'vibrant');
 ...
 // contruct vdata11
    ...
    VenueData vdata11 = new VenueData(imagelist11,'TL','004',DateTime.now(),DateTime.now(),'Chicago downtown 9', 'Chicago', 'City break', '\$\$', 'vibrant');
